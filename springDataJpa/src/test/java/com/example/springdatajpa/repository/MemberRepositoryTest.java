...
class MemberRepositoryTest {
    ...
    public void paging() {
        ...
        //when
        Page<Member> page = memberRepository.findByAge(age, pageRequest);   // 반환타입이 Page 라서 totalCount 가 필요하기 때문에 count 쿼리가 나간다.

        Page<MemberDto> toMap = page.map(m -> new MemberDto(m.getId(), m.getUsername(), null)); // api 로 할때는 Dto 로 변환 해야한다.
